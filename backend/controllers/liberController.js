...
class LiberController {
  async getAllLibra(req, res) {
    try {
...
const controller = new LiberController();

export const getAllLibra = (req, res) =>
  controller.getAllLibra(req, res);

export const shtoLiber = (req, res) =>
  controller.shtoLiber(req, res);

export const editoLiber = (req, res) =>
  controller.editoLiber(req, res);

export const fshiLiber = (req, res) =>
  controller.fshiLiber(req, res);

export const getLibraDetaje = (req, res) =>
  controller.getLibraDetaje(req, res);
